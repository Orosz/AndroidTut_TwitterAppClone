...
EditText etName;
    ...
    public void buLogin(View view) {
        ...
        StorageReference storageRef = storage.getReferenceFromUrl("gs://twitterappclone-a1536.appspot.com");
...
// Create a reference to "mountains.jpg"
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                String url="http://10.0.2.2/TwitterServer/register.php?first_name="+name+"&email="+etEmail.getText().toString()+"&pass="+etPassword.getText().toString()+"&picture_path="+ downloadUrl;
...
//login
                    String url="http://10.0.2.2/TwitterServer/login.php?email="+etEmail.getText().toString()+"&pass="+etPassword.getText().toString() ;
